				...
				<table class="table table-bordered" id="table_data">
					...
					<tbody>
						<?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td><a title="View Category" target="_blank" class="actionLink" href="/categories/<?php echo e($row['id']); ?>"><?php echo e($row['id']); ?></a> </td>
								<td><?php echo $row['title']; ?></td>
								<td>
									<span class="table-action-icons">
										<a href="<?php echo e(url('categories/'.$row['id'].'/edit')); ?>">
